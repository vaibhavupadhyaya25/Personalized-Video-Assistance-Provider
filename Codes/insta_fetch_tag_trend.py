...
def perf(taglist):
    ...
    driver.get('https://www.instagram.com/stories/highlights/17930828413239104/')
    ...
    for tag in taglist:
        ...
        print(diff)
        pfreq= int((60*9)/(diff.total_seconds()+random.randint(5,20)))
    
        # Add hashtag info to dataframe
        tag_df.loc[len(tag_df)] = [tagname, nposts1, pfreq]
